...
import { Download, FileDown, Plus, RefreshCw, Search, ShieldCheck, Sparkles, Trash2, Upload, Users } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";

export type CRMContact = {
  id: string; company_name: string; contact_name: string; job_title: string; email: string; phone: string;
  website: string; country: string; city: string; linkedin: string; source: string; status: string;
  priority: string; notes: string; deal_stage: string; lead_score: number; email_verification: string;
